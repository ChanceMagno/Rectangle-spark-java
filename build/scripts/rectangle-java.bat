...
@rem ##########################################################################
@rem
@rem  rectangle-java startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and RECTANGLE_JAVA_OPTS to pass JVM options to this script.
...
@rem Execute rectangle-java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RECTANGLE_JAVA_OPTS%  -classpath "%CLASSPATH%" Rectangle %CMD_LINE_ARGS%
...
:fail
rem Set variable RECTANGLE_JAVA_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%RECTANGLE_JAVA_EXIT_CONSOLE%" exit 1
exit /b 1
